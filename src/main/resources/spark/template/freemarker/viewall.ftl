        ...
        <#list urls as url>
            <div class="mdl-cell mdl-cell--4-col">
                <div class="demo-card-wide mdl-card mdl-shadow--2dp">
                    ...
                    <div class="mdl-card__title mdl-card--expand">
                        <a href="/p/${url.getShortURL()}" > <h2 class="mdl-card__title-text">www.syllaurl.do/${url.getShortURL()}</h2></a>
                    </div>
                    ...
                    <div class="mdl-card__menu">
                        <a href="javascript:fbShare('www.syllaurl.do/${url.getShortURL()}', 'Fb Share', 'Facebook share popup', 'https://www.colourbox.com/preview/2375712-vector-icon-of-scissors-all-layers-are-grouped.jpg', 520, 350)" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect">
