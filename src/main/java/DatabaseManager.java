...
import Entity.URL;
import Entity.User;
import Service.InfoLogORMService;
import Service.URLORMService;
import Service.UserORMService;
...
public class DatabaseManager {
    ...
    public static void BootDataBase(){
        ...
        if(users.size() == 0)
        {
            System.out.println("Errorrrr 3");
            System.out.println("\n\nCreating Admins ...");

            UserORMService.GetInstance().Create(new User("CJSylla", "Claude Junior", "Sylla", "1234", true));
            UserORMService.GetInstance().Create(new User("guest", "guest", "guest", "guest", false));
